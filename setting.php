    ...
    <div class="pg-body form clearfix">
        ...
        <div class="self-box-subject clearfix">
            ...
            <div class="self-small-item-box clearfix">
                ...
                <div class="self-small-item self-small-selection">基本资料</div>
                <div class="self-connect"></div>
			...
			<div class="self-content clearfix">
				...
				<form style="text-align: center;width: 500px;margin: 0 auto;border: 1px solid #6a6a6a;height: 360px;border-radius: 5px;padding: 20px 166.5px;" action="" method="post" name="form" enctype="multipart/form-data"  onsubmit="return check()">
    				<table class="self-table">
					<tr>
						<th scope="row">昵称：</th>
						<td> 
							<input class="input-box" type="text" name="name" lable="昵称"/> 
					...
					<tr>
						<th scope="row" >生日：</th>
						<td> 
							<input class="input-box" type="text" name="birthday" lable="生日"/>
						</td>
					</tr>
					<tr>
						<th scope="row" >个人简介：</th>
						<td>
							<textarea class="personal-profile" rows="3" cols="28" name="texta"></textarea>
						</td>
					</tr>
					<tr>
